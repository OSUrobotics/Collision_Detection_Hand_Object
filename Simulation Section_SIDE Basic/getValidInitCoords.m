...
%        disp(shapeFiles(i));
       ...
       zCoords = ones(numCoords,1)*0.05;%smalltd0.042;%0.0654; 
...
%        disp(filename);
       tryfid = fopen("../../rotated_hands/"+shapeNames(i)+"S_side_rotation.txt");
       tryformat = "%f";
...
%            hand_rot = [-0.030786 1.6863  1.6197];
