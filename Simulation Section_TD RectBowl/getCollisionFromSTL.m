function [ amountCollide, handFaces, handVerts ] = getCollisionFromSTL(objVerts, objFaces, objectSurfPoints, objectSurfaceArea, resolution, hand_loc, hand_rot)
   % resolution = 25;
...
%     disp("OLD"+new_rot);
    temp  =  new_rot(1);
    new_rot(1)  =  new_rot(2) + 1.57;
    new_rot(2) = -temp + 1.57;
    new_rot(3)  =  new_rot(3)  + 1.57;
    loc_origin = [0.0 0.06554 0.06494]; %LOCAL ORIGIN((Normal):[-0.01 -0.00654 0.0];
    new_pos_loc = hand_loc; %[0.00211326 -0.00960041  0.235808];%BIGTD-[0.00179862 0.00018602 0.13695397] MEDIUMTD-[0.00177011 0.00107267 0.12799779] SMALLTD-[0.00174161 0.00195927 0.11904207]
%     disp("hand transforms");
%     disp(new_pos_loc);
