...
function getValidInitCoords()
    ...
    scale_fact =  0.001;%---->0.00118;
    
    folder = "shape_meshes/Nigel_Large_Shapes/";
    shapeFiles = ["RectBowl.STL", "RectBowl.STL", "RectBowl.STL"];%["CubeB.stl", "CylinderB.stl", "CubeB45.stl", "Cone1B.stl", "Cone2B.stl", "Vase1B.stl", "Vase2B.stl"];
    objSurfAreas = [71663.929688, 71663.929688, 71663.929688];%[260.403015, 30490.078125, 26041.628906, 38936.878906, 33730.628906, 20662.521484, 29315.062500]; 
...
%         filename = "Coords_TD_ShortBottleM.txt";
        ...
        if (i==1)
            ...
            tra_obj = makehgtform('translate', [-0.07573,0.07573,0]);
            hand_loc = [0.00179577 0.00027468 0.085];%0.13605835];
            filename = "Coords_TD_RectBowlM.txt";
            tryfid = fopen("../../rotated_hands/additional_shapes/Rectbowl"+"M_top_rotation.txt");
            tryformat = "%f";
        ...
        elseif (i==2)
            ...
            tra_obj = makehgtform('translate', [-0.08909,0.08909,0]);
            hand_loc = [0.00185563 -0.00158728  0.088];%0.15486631];%0.22927994];
            filename = "Coords_TD_RectBowlB.txt";
            tryfid = fopen("../../rotated_hands/additional_shapes/Rectbowl"+"B_top_rotation.txt");
            tryformat = "%f";
            sizeA = [3 num_correct_vals];
            A = fscanf(tryfid,tryformat, sizeA);
            A = A';
        ...
        elseif (i==3)
            ...
            tra_obj = makehgtform('translate', [-0.06236,0.06236,0]);
            hand_loc = [0.00173591 0.00213665 0.075];%0.11725039];
            filename = "Coords_TD_RectBowlS.txt";
            tryfid = fopen("../../rotated_hands/additional_shapes/Rectbowl"+"S_top_rotation.txt");
            tryformat = "%f";
            sizeA = [3 num_correct_vals];
            A = fscanf(tryfid,tryformat, sizeA);
            A = A';
