...
%     disp(objectVox);
    ...
    loc_origin = [-0.06545 0.06569 0.0218]; %LOCAL ORIGIN((Normal):[-0.01 -0.00654 0.0];  TOP DOWN:[0.0 0.06554 0.06494];
    new_pos_loc = hand_loc;%BIGTD-[0.00179862 0.00018602 0.13695397] MEDIUMTD-[0.00177011 0.00107267 0.12799779] SMALLTD-[0.00174161 0.00195927 0.11904207]
