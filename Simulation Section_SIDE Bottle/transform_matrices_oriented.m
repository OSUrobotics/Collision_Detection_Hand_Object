...
%     global Verts;
    Verts = [];
    filename = "hello_VERTS_oriented.txt"
    filename2 = "hello_FACES_oriented.txt"
...
%         fid = fopen('hello_VERTS_oriented.txt','at');
%         fprintf(fid, '%f %f %f\n', partVerts);
%         fclose(fid);
%     
%         fid = fopen('hello_FACES_oriented.txt','at');
%         fprintf(fid, '%f %f %f\n', partFaces);
%         fclose(fid);
...
function save_mesh()
    ...
    filename = "hello_FACES_oriented.txt";
    fileID = fopen(filename);
